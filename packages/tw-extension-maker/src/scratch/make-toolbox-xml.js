...
import { BLOCKS_DARK_COLOURS as defaultBlockColors } from './blocksTheme.js';

// scratch-blocks is bundled directly here, so this "lazy loader" shim is always
// loaded (replaces scratch-gui's tw-lazy-scratch-blocks).
const LazyScratchBlocks = {
  isLoaded: () => true,
  get: () => ScratchBlocks,
};
