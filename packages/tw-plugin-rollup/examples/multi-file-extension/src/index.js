// The entry module. It imports from sibling files (which Rollup/Rolldown/Vite
// inline into one bundle) and `export default`s the extension class. The plugin
// wraps everything in the TurboWarp IIFE and registers this class for you —
// there is deliberately no `Scratch.extensions.register(...)` call here.
