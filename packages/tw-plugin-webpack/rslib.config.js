...
// The plugin is a build-tool module consumed inside webpack/Rspack configs, so
// we ship plain ESM (./dist/esm) and CJS (./dist/cjs) for Node — no browser
// bundle. `.d.ts` files are emitted from the JSDoc types in src/.
